<h2><a href="https://www.geeksforgeeks.org/problems/merge-k-sorted-arrays/1?page=3&category=Arrays,Strings,Linked%20List&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Merge k Sorted Arrays</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given <strong>K</strong> sorted arrays arranged in the form of a matrix of size K*K. The task is to merge them into one sorted array.<br>
