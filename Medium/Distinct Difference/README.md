<h2><a href="https://www.geeksforgeeks.org/problems/distinct-difference--170647/1?page=1&category=Arrays,Strings&difficulty=School,Basic,Easy,Medium&status=unsolved&sortBy=accuracy">Distinct Difference</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array A[] of length N. For each index, <strong>i (1&lt;=i&lt;=N),</strong> find the difference between the number of distinct elements in the left and right side in the of the current element in the array.&nbsp;</span></p>
