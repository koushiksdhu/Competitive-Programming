...
class Solution
{
    public static ArrayList<ArrayList<Integer>> printPaths(Node root, int sum)
    {
        ...
        traverse(root, sum, new ArrayList<Integer>(), al);
        return al;
        
    }
    static void traverse(Node root, int sum, ArrayList<Integer> temp, ArrayList<ArrayList<Integer>> al) {
        if(root == null)
            return;
        ...
        traverse(root.left, sum - root.data, temp, al);
        traverse(root.right, sum - root.data, temp, al);
